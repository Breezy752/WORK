...
function Register() {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    if (!form.username || !form.password || !form.confirmPassword) { setError('All fields are required.'); return; }
      ...
      <div className="w-full max-w-md">
        <div className="bg-white rounded-2xl shadow-2xl overflow-hidden">
          <div className="bg-blue-900 px-8 py-10 text-center">
            ...
            <p className="text-blue-300 text-sm mt-1">Create a new account</p>
          </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  required
                />
                <p className="text-xs text-gray-400 mt-1.5">Must include uppercase, lowercase, number & special character</p>
              </div>
              <div>
