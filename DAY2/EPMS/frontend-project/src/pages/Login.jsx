...
const Login = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4"
      style={{background: 'linear-gradient(135deg, #0a0a0a 0%, #1a1a1a 50%, #2d1500 100%)'}}>
      <div className="w-full max-w-md">
        <div className="rounded-2xl shadow-2xl p-8"
          style={{background: '#111111', border: '1px solid #f97316'}}>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            {error && (
              <div className="px-4 py-3 rounded-lg text-sm"
                style={{background: '#2d0000', border: '1px solid #ef4444', color: '#fca5a5'}}>
                {error}
              </div>
            )}
          ...
          <p className="text-center text-xs mt-5" style={{color: '#6b7280'}}>
            Default credentials: <span style={{color: '#f97316'}}>admin</span> / <span style={{color: '#f97316'}}>admin123</span>
          </p>
        </div>
      </div>
    </div>
